class Book < ActiveRecord::Base
  ...
  def self.get_fiction_books
    response1 = HTTParty.get("http://api.nytimes.com/svc/books/v2/lists/combined-print-and-e-book-fiction.json?api-key=087609e876114f51890cbd02598c33fc")
  ...
  def self.get_nonfiction_books
    response2 = HTTParty.get("http://api.nytimes.com/svc/books/v2/lists/combined-print-and-e-book-nonfiction.json?api-key=087609e876114f51890cbd02598c33fc")

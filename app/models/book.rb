class Book < ActiveRecord::Base
  ...
  def self.get_fiction_books
    response1 = HTTParty.get("http://api.nytimes.com/svc/books/v2/lists/combined-print-and-e-book-fiction.json?api-key=***REMOVED***")
  ...
  def self.get_nonfiction_books
    response2 = HTTParty.get("http://api.nytimes.com/svc/books/v2/lists/combined-print-and-e-book-nonfiction.json?api-key=***REMOVED***")

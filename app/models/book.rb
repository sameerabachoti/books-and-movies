class Book < ActiveRecord::Base
  ...
  API_KEY="087609e876114f51890cbd02598c33fc"

  def self.get_fiction_books
    response1 = HTTParty.get("http://api.nytimes.com/svc/books/v2/lists/combined-print-and-e-book-fiction.json?api-key=#{API_KEY}")
  ...
  def self.get_nonfiction_books
    response2 = HTTParty.get("http://api.nytimes.com/svc/books/v2/lists/combined-print-and-e-book-nonfiction.json?api-key=#{API_KEY}")
